...
void MainFrame::onCompress(wxCommandEvent& event) {
	...
	startCompressing(filePath, dirPath, 100, &root); // TODO TAKE THIS THE COMPRESSION ORDER (2) THROUGH GUI
...
void MainFrame::onDecompress(wxCommandEvent& event) {
	...
	StartDecompressing(compressedFilePath, decoderPath, dirPath);
